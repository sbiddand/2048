...
function Game() 
{
    ...
    this.startGame = function() {
        ...
        for (var i = 0; i < m_numStartNumbers; i++) {
...
function Grid() 
{
    ...
    this.checkWin = function() {
        ...
        if (winningPosition && winningPosition.length === 1 && !m_wonGame) {
            m_wonGame = true;
    ...
    this.insertRandom = function () {
        ...
        //from m_startNumbers into empty position 
        ...
        var numberToInsert = m_startNumbers[
            r.randomInt(0,(m_startNumbers.length))];
